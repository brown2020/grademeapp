...
import logo from "@/app/assets/grade192.png";
...
export default function Header() {
  ...
  return (
    <div className="z-10 flex items-center justify-between h-16 px-4 bg-[#005792]">
      <div
      ...
      >
        <Image src={logo} alt="Grade.me Logo" width={30} height={30} />
